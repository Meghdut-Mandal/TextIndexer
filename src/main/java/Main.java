...
import com.meghdut.text.SearchResultBatch;
...
public class Main
{
    public static void main(String[] args)
    {
        ...
        String searchTerm = "newton ";

        SearchResultBatch batch = index.search(searchTerm, 1000);
        batch.getSearchResults().forEach(item -> System.out.println(item.getUniqueIdentifier()+" -- "+item.getRelevanceScore()));
    }
}
